...
return (
    <nav>
        <ul>
            <li><span className='spanIcono spanIcono1'><img className="imgLogo" src="img/moodboardFenice2.png"></img></span><span className='spanPalabra spanPalabra1'>Devlinks</span></li>
            ...
            <li><Link className="li li4" to='/preview'><span className='spanIcono spanIcono4'><img className="imgLogo2" src="img/moodboardFenice4.png"></img></span><span className='spanPalabra spanPalabra4'>Preview</span></Link></li>
        </ul>
    </nav>
)
}
